/*
  ...
  Copied from https://github.com/arduino-libraries/RTCZero
  Mike Lawrence changed:
    1. Added getTime()
    2. Switch to Generic Clock 4
...
void RTCZero::begin(bool resetTime)
{
  ...
  // Setup clock GCLK4 with XOSC32K divided by 32
  configureClock();
...
RTC_MODE2_CLOCK_Type RTCZero::getTime()
{
  RTCreadRequest();
